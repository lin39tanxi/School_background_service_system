...
@Insert("insert into feedback (user_id, content,is_anonymous,created_time,image_urls) " +
    ...
    Page<GetFeedbackVO> getList(@Param("userId") Integer userId, @Param("orderKey") String orderKey, @Param("beginTime") LocalDate beginTime, @Param("endTime") LocalDate endTime);
